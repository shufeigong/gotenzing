        ...
        <h4 className="panel-title hidden-xs">
          <a data-toggle="collapse" data-parent="#accordion" href={href} className="name">
            ...
            {this.props.data.name}
                    ...
                    <span className="additional-info pull-right">| <span className="obl">{this.props.data.title}</span> | <span
                      className="obl">{this.props.data.what_you_do}</span> | <span
                      className="bold-obl">{this.props.data.spirtual_role}</span>
                    </span>
        </h4>
